	...
	class Awl_Media_Slider {
		...
		*/
		public function _ms_admin_add_meta_box() {
			...
			add_meta_box( '', __('Add Image/Video', MSP_TXTDM), array(&$this, 'ms_upload_multiple_images'), 'media_slider', 'normal', 'default' );
		}
		...
		public function ms_upload_multiple_images($post) {
				...
				//wp_enqueue_script( 'awl-ms-color-picker-js', plugins_url('js/ms-color-picker.js', __FILE__ ), array( 'wp-color-picker' ), false, true );
				?>
				<div id="media-slider-gallery">
					...
					foreach($allimagesetting['media-slide-ids'] as $id) {
						...
						$slide_desc =  $allimagesetting['media-slide-desc'][$count];
						?>
						<li class="media-slide">
							...
							<textarea name="media-slide-desc[]" id="media-slide-desc[]" style="width: 100%;" placeholder="Enter Description"><?php echo $slide_desc; ?></textarea>
				...
				<span class="add-text"><?php _e('Add Image / Video', MSP_TXTDM); ?></span>
		...
		public function _ms_ajax_callback_function($id) {
			...
			<li class="media-slide">
				...
				<input type="text" name="media-slide-title[]" id="media-slide-title[]" style="width: 100%;" placeholder="Title Here" value="<?php echo get_the_title($id); ?>">
				<textarea name="media-slide-desc[]" id="media-slide-desc[]" style="width: 100%;" placeholder="Enter Description"><?php echo $description; ?></textarea>
